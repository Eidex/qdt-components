...
export default class QdtViz extends React.Component {
  ...
  render() {
    if (this.state.error) {
      ...
      return <div style={{ 'text-align': 'center', height: '200px' }}><img src="./Ellipsis-6.2s-200px.svg" alt="" /></div>;
    }
    const { width, height } = this.props;
    return <div ref={(node) => { this.node = node; }} style={{ width, height }} onClick={() => { console.log('qdt clicked!'); }}><img src="./Ellipsis-6.2s-189px.gif" alt="" /></div>;
  }
}
